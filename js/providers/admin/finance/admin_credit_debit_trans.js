        ...
        columns: [
            {
                ...
                render: function (data, type, row, meta) {
                    return new String(row.transfered_on).dateFormat("dd-mmm-yyyy H:M:s");
                }
            },
            {
                data: "transaction_id",
           ...
           /*  {
                ...
                render: function (data, type, row, meta) {
                    var trans_type = '';
                    if (parseInt(row.transfer_type) == 0) {
                        trans_type = '<span class="text-danger">' + row.trans_type + '</span>';
                    } else {
                        trans_type = '<span class="text-success">' + row.trans_type + '</span>';
                    }
                    return new String(trans_type);
                }
            }, */
            {
                data: "amount",
