$(document).ready(function () {
        ...
        columns: [
            ...
            },
			{
                ...
                render: function (data, type, row, meta) {
                    ...
                    action_buttons += '<li><a href="' + document.location.BASE + 'admin/category/online-store/edit"  class="edit_btn" data-category_id="' + row.bcategory_id + '" data-parent_category_id="' + row.parent_bcategory_id + '" data-category_name="' + row.bcategory_name + '">Edit</a></li>';
                    action_buttons += (row.status == Constants.ACTIVE)
                            ? '<li><a data-status="' + Constants.INACTIVE + '" data-category_id="' + row.bcategory_id + '" href="' + document.location.BASE + 'admin/category/online-store/change-status" class="change_status">Inactive</a></li>'
                            : '<li><a data-status="' + Constants.ACTIVE + '" data-category_id="' + row.bcategory_id + '"  href="' + document.location.BASE + 'admin/category/online-store/change-status" class="change_status">Active</a></li>';
    ...
    $('#cat_listfrm').on('click', '.add_btn', function (e) {
        ...
        $('#image_url-preview').attr('src', document.location.BASE + 'resources/uploads/bcategories/no_image.jpg');
    ...
    $('#category_editfrm').on('click', '#choose_category', function (e) {
        ...
        if (catInfo.parent_bcategory_id != 0) {	
            ...
            if (! $.isEmptyObject(catInfo)) {
                ...
                $.ajax({
                    url: document.location.BASE + 'admin/online-store/getcategory',
                    dataType: "json",
                    type: 'POST',
                    beforeSend: function () {
                        $('#catSelect').empty();
    ...
    $('#bcategory_slug, #bcategory_name').blur(function (e) {
        ...
        $.ajax({
            url: document.location.BASE + 'admin/category/online-store/check-slug',
