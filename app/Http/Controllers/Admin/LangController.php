...
class LangController extends AdminController
{
    ...
    public function langLoad ($langKey = '')
    {
	   ...
	   case 'online_category':
                echo 'var $online_category_valmsg  = {
					bcategory_name: {
						required:\''.trans('admin/online_category/category.enter_category').'\',
						pattern:\''.trans('admin/online_category/category.invalid_category').'\'
					},
					bcategory_slug: {
						required:\''.trans('admin/online_category/category.enter_url').'\',
						pattern:\''.trans('admin/online_category/category.invalid_url').'\'
					},
				};
				var $wrong_msg=\''.trans('general.something_wrong').'\'';
                break;
				
		 case 'in-store_category':
                echo 'var $online_category_valmsg  = {
					bcategory_name: {
						required:\''.trans('admin/online_category/category.enter_category').'\',
						pattern:\''.trans('admin/online_category/category.invalid_category').'\'
