...
(function(h) {
	...
	function Ic(a, b, c) { h(a).bind("change.DT,stepUp.DT,stepDown.DT", b, function (b) {a.attr('disabled', true); a.blur(); c(b); }); } 
    ...
    h.extend(m.ext.classes, {
		...
		sPageSpan: "paginate_span", 
		sPageEmpty: "paginate_empty",
    ...
    h.extend(Nb, {
		...
		input_page: function(a, b) {
			/*return ["previous", "input_page", "next"]*/
			return["pages_span", "empty", "previous", "next"]
		},
        _numbers: ia,
        numbers_length: 7
    });
