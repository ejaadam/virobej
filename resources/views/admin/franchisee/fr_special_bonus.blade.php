    ...
    <div class = "row">
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                <form name="specialBonusFrm" id="specialBonusFrm" method="post" action="<?php echo URL::to('admin/support-center/bonus/update-status');?>">
...
{{HTML::script('js/providers/admin/franchisee/franchisee/special_bonus.js')}}
@stop
