    ...
    <div class = "row">
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                <form name="specialBonusFrm" id="commissionFrm" method="post" action="<?php echo URL::to('admin/support-center/contribution-commission/update-status');?>">
                    <table id="commission_table" class="table table-bordered table-striped franchi_list">
                        <thead>
                            <tr>
                                <th><input type="checkbox" class="simple"  name="check-all" id="check_all"/></th>
                                <th>Date</th>
                                <th>From</th>
                                <th>To</th>
...
{{HTML::script('js/providers/admin/franchisee/commission_report.js')}}
@stop
