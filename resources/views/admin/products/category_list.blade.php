...
<section class="content">
		...
		<div class="col-md-12" id="Category_list">
			<div class="panel panel-default" >
				...
				<div class="panel_controls">
					<div class="row">   <!--  admin.seller.in_store.category-list  -->
				        <form id="cat_listfrm" name="cat_listfrm" class="form form-bordered" action="{{route('admin.category.products.category-list')}}" method="get">
    ...
    <div class="panel panel-default"  id="Category_edit" style="display:none">
        ...
        <div class="panel-body">
			<!-- form start -->
			<form method="post" class="form-horizontal form-bordered form-validate" id="category_editfrm" action="{{route('admin.category.products.update')}}" autocomplete="off"  enctype="multipart/form-data">   
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<div class="input-group">
							<input type="text" name="bcategory_slug" id="bcategory_slug" class="form-control"  placeholder="{{trans('admin/in_store_category.url_ph')}}" value="" data-err-msg-to="#catslug-err" readonly>
							<a class="input-group-addon" href="javascript:void(0);" id="editslugBtn"><i class="icon-edit"></i></a>
						</div>
						<span id="catslug-err"></span>
				    </div>
				</div>
				<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close modal-close_btn" data-dismiss="modal"> <i class="icon-remove"></i></button>
					<h4 class="modal-title">{{trans('admin/in_store_category.parent_category')}}</h4>
				</div>
				<div class="modal-body" style="height: 300px;">
					<p id="cat_link"></p>
					<select name="" id="catSelect" class="form-control" data-parent-id=""></select>
				</div>
				<div class="modal-footer">
					<button type="button" class="modal-finish_btn btn btn-success" data-dismiss="modal">Continue</button>
				</div>
			</div>
		</div>
	</div>
...
<script src="{{asset('js/providers/admin/product/product_categories.js')}}"></script>
@stop
