...
@section('layoutContent')
    ...
    <div class="col-sm-12" id="list-panel">
        <div class="panel panel-default">
            ...
            <div class="panel_controls">
                <div class="row">
                    <form id="listfrm" class="form form-bordered" action="{{route('admin.online.store-list')}}" method="post">
                        <div class="input-group col-sm-3">
                             <input type="search" id="search_text" name="search_text" class="form-control" placeholder="{{trans('admin/general.search_term_ph')}}" value="{{(isset($search_text) && $search_text != '') ? $search_text : ''}}" />
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu dropdown-menu-form dropdown-menu-right" id="chkbox">
                                    <li><label class="col-sm-12"><input name="filterTerms[]" class="filterTerms" value="UserName" type="checkbox" >Network</label></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                 <input class="form-control" type="text" id="from" name="from_date" placeholder="From date">
                                <span class="input-group-addon">-</span>
                                 <input class="form-control" type="text" id="to" name="to_date" placeholder="To date">
                            </div>
                        </div>
  ...
  <div class="col-sm-12" id="form-panel" style="display:none">
    
    <div class="panel panel-default">
	   <div class="panel-heading">
	    <div class="box-tools pull-right">
                    <button class="btn bg-red btn-sm back-to-list"><i class="fa fa-close fa-fw"></i>Close</button>
                </div>
                <h4 class="panel-title">Add Online Store Details</h3>
            </div>
	
	<div class="panel-body">
	<form class="form-horizontal form-bordered" id="affiliate-form" action="{{route('admin.online.store-save')}}" method="post" novalidate="novalidate" autocomplete="off">
		    ...
		    <div class="tab-content">
			       ...
			       <div class="tab-pane active" id="edit-store-info">
                    ...
                    <div class="form-group" id="bannerFld" style="display:none;">
                        ...
                        <div class="col-sm-6" id="banner-preview">
