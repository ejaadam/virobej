...
@section('title','Member Fund Transfer History')
@section('breadcrumb')
<li><a href="#"><i class="fa fa-dashboard"></i>'Member Fund Transfer History'</a></li>
@stop
@section('layoutContent')
<div class="col-md-12">
    <div class="box box-primary" id="member_list">
        <div class="box-header with-border" >
            <form id="form" class="form form-bordered" action="{{route('admin.finance.fund-transfer-history')}}" method="post">
                <div class="col-sm-3">
                ...
                <div class="col-sm-2">
				 ...
				 <div class="col-sm-2">
                    <div class="form-group has-feedback">
                        <label for="to_date">Role</label>
                      <select name="sysrole" id="sysrole" class="form-control">
						<option value="">Select</option>
						@foreach($sys_roles as $sys_role)
							@if($sys_role->system_role_id != 1)
								<option value="{{$sys_role->system_role_id}}">{{$sys_role->system_role_name}}</option>
							@endif
						@endforeach
					  </select>
                    </div>
