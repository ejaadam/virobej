...
@section('title',trans('admin/finance.merchant_credit_debit'))
@section('breadcrumb')
...
<div class="col-md-12">
    <div class="box box-primary" id="member_list">
        <div class="box-body">
            ...
            <form id="search_form" class="form-horizontal form form-bordered" class="" autocomplete="off" action="{{route('admin.finance.fund-transfer.find_merchant')}}" method="post">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="email">{{trans('admin/finance.mrid')}}:</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="mrcode" placeholder="Merchant Code" name="mrcode" value="{{$mrcode or ''}}"/>
                        <div id="mrerror"></div>
                    </div>
                </div>
                <div id="details_div" style="display:none">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="email">{{trans('admin/finance.business')}}:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="business" name="business" disabled>
                        </div>
                    </div>
					 <div class="form-group">
...
@stop
@push('scripts')
<script src="{{asset('js/providers/admin/finance/merchant_credit_debit.js')}}"></script>
