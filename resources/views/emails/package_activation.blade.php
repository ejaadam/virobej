...
<multiline label="content1">
    <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Your account has been activated Successfully.</p>
            ...
            <multiline label="content2">
                <table  class="wrapper last">
                    <tbody>
                        ...
                        <tr><td>Total Users Added  :  {{$users_added}}</td></tr>
                        <tr><td>User Balance  :  {{$user_balance}}</td></tr>
                        <tr><td>Activated Date  :  {{$activation_date}}</td></tr>
                        <tr><td>Expiry Date  :  {{$expiry_date}}</td></tr>                        
                    </tbody>
                </table>
            </multiline>
    </td>
