...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" style="border-collapse: collapse;" width="600"><!--start title-->
    <tbody>
        <tr>
            <td align="" class="h3 b title-td" mc:edit="title" style="font-family: 'Playfair Display'; font-weight: 400; color: #262424; font-size: 24px; line-height: 35px; font-style: italic;"><singleline label="title" style="margin-right:400px">Dear,  <?php echo $user_name;?></singleline></td>
</tr>
<tr>
            ...
            <multiline label="content2">
                <table  class="wrapper last">
                    <tbody>
                        ...
                        <tr><td><a href="{{URL::to('/partner/login')}}">Login Now</a></td></tr>
                    </tbody>
                </table>
            </multiline>
    </td>
