...
<multiline label="content1">
    <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Thank you for registering with {{$pagesettings->site_domain}}.</p>
    <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Your Account Detail.</p>
</multiline>
</td>
</tr>
<!--end content-->
        ...
        <table align="left"  border="0" cellpadding="0" cellspacing="0" class="col2" style="border-collapse: collapse;border: none;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" width="0">
            ...
            <multiline label="content2">
                <table  class="wrapper last">
                    <tbody>
                        <tr><td>User ID : <?php echo $user_name;?> </td></tr>
