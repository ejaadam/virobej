...
<multiline label="content1">
    ...
    <p><strong>Email/Login ID</strong> : {{$uname}}</p>
    <p>You can use the following password reset code:</p>
    <p style="font-size:20px; display:inline-block; background-color:#f4f4f4; color:#000000; border:1px solid #f0f0f0;border: 1px solid #f0f0f0; padding: 10px 15px;">{{$reset_code}}</p>
</multiline></td>
</tr>
<!--end content-->
</tbody>
