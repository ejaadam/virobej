                        ...
                        <table width="763" cellpadding="0" cellspacing="0" border="0" align="center">
                            ...
                            <tr>
                                <td width="763" valign="top">
                                    <table width="763" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td width="61"></td>
                                            <td width="641" style="background:transparent url({{URL::asset('resources/assets/img-email/header-top.png')}}) no-repeat left top; height:222px"></td>
                                            <td width="61"></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td width="763" valign="top">
                                    <table width="763" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td width="61"  style="background:transparent url({{URL::asset('resources/assets/img-email/envelope-corner-top-left-middle.png')}}) no-repeat left top;"></td>
                                            <td width="641" align="center" valign="middle"   style="background:transparent url({{URL::asset('resources/assets/img-email/envelope-1.png')}}) no-repeat left top; height:177px;"><div style="position:relative; text-align:center"><div style="position:absolute; width:100%; top:40px"><a href=""><img src="{{URL::asset('resources/assets/img-email/facebook.png')}}" alt="" width="25" height="25" border="0"/></a></div></div></td>
                                            <td width="61"  style="background:transparent url({{URL::asset('resources/assets/img-email/envelope-corner-top-right-middle.png')}}) no-repeat left top;"></td>
                                        </tr>
                                        <tr>
                                            <td width="61" style="background:transparent url({{URL::asset('resources/assets/img-email/envelope-corner-top-left-bottom.png')}}) no-repeat left top; height:241px;"></td>
											
                                            <td width="641"  align="center" valign="middle" style="font-family:Tahoma, Geneva, sans-serif; background:transparent url({{URL::asset('resources/assets/img-email/envelope-2.png')}}) no-repeat left top; height:241px; color:#ffffff" >
                                                <div style="width:60%; margin:0px auto">
                                                        <strong>Regards,</strong><br/> The {{$pagesettings->site_name}} Team                                                        
                                                        <p style="font-size:12px;color:#fff">{{(isset($pagesettings->address->country)) ? $pagesettings->address->country : $pagesettings->address->others }}</p>
                                                </div>
                                            </td>
											
                                            <td width="61" style="background:transparent url({{URL::asset('resources/assets/img-email/envelope-corner-top-right-bottom.png')}}) no-repeat left top; height:241px;"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr><td width="639" height="1"><img src="{{URL::asset('resources/assets/img-email/line-dashed.png')}}" alt="" width="561" height="1" border="0" style="display:block;" /></td></tr>
                                                </table>
                                            </td>
                                            <td width="61"></td>
                                        </tr>
