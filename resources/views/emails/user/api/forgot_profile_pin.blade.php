...
<tr>
	<td style="padding:0px 0px 0px 240px;">
		<h3><a href="" style="background-color:#007fcb;padding:12px 37px;color:white;text-decoration: none; border-radius:5px">Reset</a></h3>
	</td>
</tr-->
<tr>
	<td>
		<p style="color:#990000;">You can create a new Security PIN by entering OTP (One Time Password)</p>
