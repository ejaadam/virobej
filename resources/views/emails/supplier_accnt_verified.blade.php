@extends('emails.supplier.maillayout')
@section('content')
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" style="border-collapse: collapse;" width="600"><!--start title-->
    <tbody>
        <tr>
            <td align="" class="h3 b title-td" mc:edit="title" style="font-family: 'Playfair Display'; font-weight: 400; color: #262424; font-size: 24px; line-height: 35px; font-style: italic;"><singleline label="title" style="margin-right:400px">Dear,  {{$supplier_details->uname}}</singleline></td>
</tr>
<tr>
...
<multiline label="content1">
    <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Thank you for registering with <?php echo $pagesettings->site_name;?>. Your Account Detail.</p>
</multiline>
</td>
</tr>
<!--end content-->
            ...
            <tbody>
                <tr>
                    <td align="left" class="content gray" mc:edit="content2" style="font-family: Raleway, Arial; font-weight: 400; font-size: 13px; line-height: 19px; color: #585858; -webkit-font-smoothing: antialiased;">
                        <p>Your account has been activated and verified, You can start you products promotion now..</p>
            <multiline label="content2">
                <table  class="wrapper last">
                    <tbody>
                        <tr><td>Account Email/Username : <?php echo $supplier_details->email;?> </td></tr>
                        <tr><td>Account ID : <?php echo $supplier_details->uname;?> </td></tr>
                        <tr><td><a href="{{URL::to('supplier/login')}}">Login Now</a></td></tr>
                    </tbody>
                </table>
            </multiline>
    </td>
