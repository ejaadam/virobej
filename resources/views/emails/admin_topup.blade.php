...
<multiline label="content1">
    <p style="font-family: 'Playfair Display', Arial; font-weight: 400; font-size: 15px; line-height: 21px; color: #252525; -webkit-font-smoothing: antialiased; margin: 0px !important;">Package added successfully.</p>
            ...
            <multiline label="content2">
                <table  class="wrapper last">
                    <tbody>
						...
						<tr><td>Total User         :  {{$required_user}}</td></tr>
                        <tr><td>Total cost         :  {{$price}}</td></tr>
                        <tr><td>Per User cost      :  {{$per_user_cost}}</td></tr>
				    </tbody>
                </table>
            </multiline>
    </td>
