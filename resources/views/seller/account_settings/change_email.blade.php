<div class="greybox">
	<div class="greybox-body form" id="change-email">					
		<form id="verify-propin-form" class="form-horizontal" action="{{route('seller.verify-profile-pin')}}" method="post" style="display: none;">
		<!--	<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group">
						 <input {!!build_attribute($profile_pin_verify_fileds['profile_pin']['attr'])!!} id="profile_pin" class="form-control" data-err-msg-to="#verify_propin-err" onkeypress="return isNumberKey(event)" />
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-8">
					<button type="submit" id="veriy-pin-btn" class="btn btn-success" >Verify</button>&nbsp;&nbsp;&nbsp;
					<button type="button" id="cancel-change-email" class="btn btn-danger cancel-change-email">Cancel</button>
				</div>
			</div>
		</form>
		<form id="reset-pinfrm" class="form-horizontal" action="{{route('seller.profile-settings.profile-pin.reset')}}" method="post" style="">
			<!--<div class="form-group">
			...
			<div class="verify-profile-pin">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input {!!build_attribute($profile_pin_forgot_fileds['code']['attr'])!!} id="code" class="form-control"/><br>
		...
		<div class="new-profile-pin" style="display: none;">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
							<input {!!build_attribute($profile_pin_forgot_fileds['profile_pin']['attr'])!!} id="profile_pin" class="form-control" data-err-msg-to="#new_pin-err" onkeypress="return isNumberKey(event)"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
							<input {!!build_attribute($profile_pin_forgot_fileds['confirm_profile_pin']['attr'])!!} id="confirm_profile_pin" class="form-control" data-err-msg-to="#cnfrm_pin-err" onkeypress="return isNumberKey(event)"/>
		...
		<form id="change-email-new-email" class="form-horizontal" action="{{route('seller.profile-settings.change-email.new-email-otp')}}" method="post" style="display: none;">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group">
						...
						<input {!!build_attribute($change_email_newemail_fileds['email']['attr'])!!} id="email" class="form-control"  onkeypress="return RestrictSpace(event)" data-err-msg-to="#new_email-err" />						
					</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-8">
					<button type="submit" class="btn btn-success" disabled="disabled">Change</button>&nbsp;&nbsp;&nbsp;
					<!--<button type="button" id="cancel-change-email" class="btn btn-danger cancel-change-email">Cancel</button>-->
				</div>
			</div>
		</form>
        <div class="" id="verify_link_success" style="display:none;"></div>		
		<!--form id="change-email-confirm" class="form-horizontal" action="{{route('seller.profile-settings.change-email.confirm')}}" method="post" style="display: none;">						
			<!--div class="form-group">
				...
				<div class="col-sm-8">
					<input {!!build_attribute($change_email_confirm_fileds['code']['attr'])!!} id="code" class="form-control" onkeypress="return isNumberKey(event)"/><br>
