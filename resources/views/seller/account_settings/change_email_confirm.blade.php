...
<div class="row">
	<div class="col-sm-12" {!!($change_email)? '' : 'style=display:none;'!!}> <!-- style=display:none; -->
		<div class="panel panel-default">
			<div class="panel-heading">
                <h4 class="panel-title"><!--i class="icon-undo"></i--> Change Email</h4>
			</div>
	...
	<div class="col-sm-12" {!!($change_email)? 'style=display:none;' : ''!!}>
		<div class="panel panel-default">
			<div class="panel-heading">
