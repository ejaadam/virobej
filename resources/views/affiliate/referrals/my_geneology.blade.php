						...
						<div class="panel-body">
							<div class="tree col-md-6">
								...
								<ul>
									...
									$my_treeinfo->full_name .'('.$my_treeinfo->uname.')' . ' </b> - Team (' .$my_treeinfo->team_count. ')';?>									
									</span> 
							...
							<div class="col-md-4 pull-right" id="user_info">
								...
								<div class="col-md-6">{{ trans('affiliate/referrels/generation_viewer_my_genelogy_dir.direct_member')}}</div>  <div class="col-md-6" id="tree_acddown_cnts"></div><br>
...
<link rel="stylesheet" href="<?php echo URL::asset('resources/assets/themes/affiliate/css/treeview.css');?>" />
    </section>
    <!-- /.content -->
@stop
@section('scripts')
