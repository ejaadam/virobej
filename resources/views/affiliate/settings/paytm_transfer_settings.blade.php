<form action="<?php echo URL('account/settings/account_payout_settings_update');?>" method="post" class="paytm_transferfrmad" id="form_{{$acpayout_setting_id or ''}}" data-id="{{$acpayout_setting_id or ''}}">
	...
	<div class="form-group col-sm-12">
		<label class="col-sm-6 control-label" for="paytm_account_id">{{trans('affiliate/settings/payout_settings.paytm_account_id_label')}}</label>
		<div class="col-sm-6">
			<input name="paytm_account_id" class="form-control" type="text" id="paytm_account_id" placeholder="{{trans('affiliate/settings/payout_settings.paytm_account_id_place')}}" value="{{ isset($acinfo)? $acinfo->paytm_account_id:'' }}" />
		</div>
	</div>
    <div class="form-group col-sm-12">
	...
	<div class="form-group col-sm-12">
		...
		<div class="col-sm-6">
			<button type="submit" class="btn btn-sm bg-olive paytm"  value="1"> {{ ( !isset($acpayout_setting_id) ? trans('affiliate/settings/payout_settings.add_now') : trans('affiliate/settings/payout_settings.update_now') ) }} </button>
		</div>
	</div>
</form>