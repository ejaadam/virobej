<header class="main-header">
    ...
    <a href="{{route('aff.dashboard')}}" class="logo">
      ...
      <div class="logo-lg">{{$pagesettings->site_name}}</div>
    </a>
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('resources/assets/themes/affiliate/dist/img/default-profile.png')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{$userSess->full_name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
