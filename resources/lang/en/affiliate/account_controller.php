...
return [
    ...
    'signup_success'=>['title'=>"Congratulations", 'desc'=>"<h1 class='text-success'>Congratulations!</h1><p>Your account created successfully, To activate your account we've sent an email to verify your email address. Please check your inbox."],
    ...
    'login_link'=>'<p style="text-align:center"> Click here to <a style="color: #26f700;" href=":login_link" class="" >Login</a></p>',
];
